...
const todoItem = () => {
  return `
    <input id="bx--checkbox-1" class="bx--checkbox" type="checkbox" value="green" name="checkbox">
      <label for="bx--checkbox-1" class="bx--checkbox-label">
        <span class="bx--checkbox-appearance">
          <svg class="bx--checkbox-checkmark">
            <svg width="12" height="9" viewBox="0 0 12 9" fill-rule="evenodd">
  ...
  for (var i = 0; i < todos.length; i++) {
    $('#todoList').append(
      `<li class="item">
        ...
        ${todos[i].todo}
        <svg class="button" onclick="deleteItem(${i}) width="16" height="16" viewBox="0 0 16 16" fill-rule="evenodd">
